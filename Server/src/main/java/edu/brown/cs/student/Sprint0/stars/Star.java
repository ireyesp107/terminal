package edu.brown.cs.student.Sprint0.stars;

import edu.brown.cs.student.Sprint0.kdtree.KdTreeNode;
...
public record Star(long id, String name, double x, double y, double z) implements KdTreeNode {
  ...
  /**
   * used to test parsed star data in tests
   *
   * @return double that is the x point
   */
